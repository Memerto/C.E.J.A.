<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Libro.aspx.cs" Inherits="Web_App_Libro.Libro" %>
...
<!--Contenedor Principal-->
 <div id="container" class="container">
			...
			<div class="menu-panel">
				<h3><asp:Image ID="logo" src="imag/Logo%20alpha2.png" width="50px" ImageAlign="Left" runat="server" />Libro</h3>

               <!--menu propiamente del libro-->
               <ul id="menu-toc" class="menu-toc">
				...
				</ul><!--cierre del menu propio del libro-->

                <!--Donde pueden ir los links-->
                <div>
                <a href="WebForm1.aspx">Un link</a>
                <a href="WebForm2.aspx">Otro link</a>
                </div><!--cierre de links-->

			</div><!--cierre menu barra lateral-->
     
             <!--contenedor de las hojas con el menu en miniatura y las fechas (<- ->) -->
            <div class="bb-custom-wrapper">

            <!--contenedor de solo las hojas -->
            <div id="bb-bookblock" class="bb-bookblock">

            <!--item que contiene una hoja-->
            <div class="bb-item" id="item1">
						
                        <!--contenedor de hoja y scroller-->
                        <div class="content">

                            <!-- creo que debe ser el que le da el efecto con la barra lateral de subida y bajada en la hoja-->
							<div class="scroller">
								<h2>Hoja Pricipal</h2>
							...
							</div><!--  cierre del que debe ser el que le da el efecto con la barra lateral de subida y bajada en la hoja-->
						</div><!--contenedor de hoja y scroller-->
					</div><!-- cierre item que contiene una hoja-->
					...
					<div class="bb-item" id="item2">
						...
						</div><!-- cierrre contenedor de hoja y scroller-->
					</div><!-- cierre item que contiene una hoja-->
             ...
             </div><!--contenedor de solo las hojas -->

            <!--Navegadores de hojas-->
             <nav>
                
					<span id="bb-nav-prev">&larr;</span>
					<span id="bb-nav-next">&rarr;</span>
		    </nav><!--cierre de navegadores de hojas -->

                <!--barra del menu miniatura-->
                <span id="tblcontents" class="menu-button">Barra de menu miniatura</span>
             
        	    
				

			</div><!-- cierre contenedor de las hojas con el menu en miniatura y las fechas (<- ->) -->
				
		</div><!-- cierre Contenedor Principal -->

        <!--referencias de scripts y script iniciar page-->
		...
		</script><!-- cierre referencias de scripts y script iniciar page-->
</body>
</html>
